...
QT_MOC_LITERAL(1, 6, 11), // "err_occured"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "Demux\0err_occured\0"
};
...
void Demux::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Demux::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Demux::err_occured)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Demux::err_occured(int _t1)
{
