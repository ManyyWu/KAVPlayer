...
QT_MOC_LITERAL(1, 8, 11), // "err_occured"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "Decoder\0err_occured\0"
};
...
void Decoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Decoder::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Decoder::err_occured)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Decoder::err_occured(int _t1)
{
